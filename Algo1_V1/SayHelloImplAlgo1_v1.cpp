...
HRESULT SayHelloImplAlgo1_v1::QueryInterface(REFIID   riid,
    LPVOID* ppvObj)
{
...
ULONG SayHelloImplAlgo1_v1::AddRef()
{
    return InterlockedIncrement(&m_cRef);
}
ULONG SayHelloImplAlgo1_v1::Release()
{
...
void SayHelloImplAlgo1_v1::Hello()
{
    ...
    std::string theblese = theCommomInfrastructure->get_text("jennifer connelly");

    std::cout << "\nHello " << theblese << "from ver 1 !\n" << __FILE__;
