...
HRESULT SayHelloImplAlgo1_v2::QueryInterface(REFIID   riid,
    LPVOID* ppvObj)
{
...
ULONG SayHelloImplAlgo1_v2::AddRef()
{
    return InterlockedIncrement(&m_cRef);
}
ULONG SayHelloImplAlgo1_v2::Release()
{
...
void SayHelloImplAlgo1_v2::Hello()
{
